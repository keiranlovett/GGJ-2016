...
public class pauseFreeCamera : MonoBehaviour {
    ...
    void Update()
     ...
     /*   if (Input.GetAxisRaw("mouse_axis_1") != 0)
        {
                transform.localPosition = transform.localPosition + (transform.forward * Input.GetAxisRaw("mouse_axis_1") * 0.035f);
        }
        if (Input.GetAxisRaw("mouse_axis_0") != 0)
        {
                transform.localPosition = transform.localPosition + (transform.right * Input.GetAxisRaw("mouse_axis_0") * 0.035f);
        }
*/
