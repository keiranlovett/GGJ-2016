...
public class BodyPhysicsController: MonoBehaviour
{
	...
	public State currState_ = State.DEFAULT;
    ...
    public Vector3 m_GOVelocity = Vector3.up; //the overall speed for the entire game object. This should be set by the movement script
