...
public class PhysicsBodyPart : MonoBehaviour
{
	...
	void OnCollisionEnter(Collision collision)
	{
        ...
        {
            //PhysicsBodyPart otherPhysicsBodyPart = collision.gameObject.GetComponent<PhysicsBodyPart>();
            //collision.gameObject.transform.root.GetComponent<BodyPhysicsController>().Collision(otherPhysicsBodyPart.GetComponent<Rigidbody>());
            //transform.root.GetComponent<BodyPhysicsController>().Collision(otherPhysicsBodyPart.GetComponent<Rigidbody>());
